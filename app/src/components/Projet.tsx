...
export default function Projet({ imagePath, titre, techs, description }: props) {
    return (
        <>
            <div className="w-full lg:w-1/4 p-6 bg-gray-700 rounded-xl flex flex-col items-center pt-12 gap-6 transition-transform hover:-translate-y-2 hover:cursor-pointer">
