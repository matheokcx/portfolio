...
export default function Home() {
    ...
    const trouverDonnees = async () => {
        await fetch("/dataEnglish.json").then((reponse: Response) => reponse.json()).then((data: any) => {
    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col bg-white dark:bg-gradient-to-tl dark:from-blue-900 dark:to-black text-black dark:text-white font-sans bg-fixed gap-24">
                ...
                <img src="/francais.png" alt="Portfolio en français" width="60" height="60" onClick={() => router.push("/")} className="absolute top-4 right-4 hover:cursor-pointer" />
                ...
                <div className="w-full flex flex-col-reverse lg:flex-row items-center p-8 lg:p-20 pt-32 gap-16">
                    <span className="w-full lg:w-1/2 flex flex-col gap-4 font-bold animate-slide_up">
                        <h3 className="text-4xl w-full lg:w-auto">“Each day is a change to challenge himself„</h3>
                        <i className="text-gray-400">- Deleplanque Mathéo</i>
                    </span>
                    <img src="/illustration1.jpg" alt="Illustration 1" className="rounded-2xl w-full lg:w-1/2 h-96 animate-slide_up shadow-lg shadow-blue-400 transition-transform hover:scale-102 hover:-translate-y-2" />
                </div>
                ...
                <div className="w-full flex flex-col gap-20 mt-44">
                    <div className="w-full lg:h-96 dark:bg-gray-900 rounded-xl flex flex-col lg:flex-row items-center gap-8 p-8">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-normal gap-8 lg:pl-8">
                            <h2 className="font-bold text-2xl text-center lg:text-left w-full lg:w-3/4">About me</h2>
                            <p className="text-lg text-center lg:text-left w-full lg:w-3/4">My name is Mathéo, I'm 18 years old and I'm passionate about the IT and web developpement since 3 years.
                            </p>
                        </div>
                    </div>

                    <div className="w-full dark:bg-gray-900 rounded-xl flex flex-col gap-20 p-8">
                        <h2 className="w-full text-center font-bold text-3xl">Qualities</h2>
                ...
                <div className="w-full lg:h-[400px] dark:bg-gray-900 rounded-xl flex flex-col lg:flex-row gap-12 p-8">
                    <h2 className="w-full lg:w-2/6 font-bold text-3xl text-center lg:-rotate-90">Graduations</h2>
                ...
                <div className="w-full dark:bg-gray-900 rounded-xl flex flex-col items-center gap-8 p-8">
                    <h2 className="w-full lg:w-2/6 font-bold text-3xl text-center">Professional experiences</h2>
                    <div className="w-2/3 rounded-xl bg-gray-700 flex flex-col p-6">
                        <h2 className="w-full lg:w-2/6 font-bold text-xl">Chief of caisse</h2>
                        <p>GPE Leader - Aout 2024</p>
                        <ul>
                            <li>Make inventory</li>
                            <li>Put articles in fridges / store </li>
                            <li>Customers payements management</li>
                            <li>Cleaning workspace</li>
                        </ul>
                    </div>
                    <div className="w-2/3 rounded-xl bg-gray-700 flex flex-col p-6">
                ...
                <div className="w-full dark:bg-gray-900 rounded-xl flex flex-col gap-12 p-8">
                    <h2 className="font-bold text-center text-3xl w-full">Skills</h2>
                    ...
                    <div className="w-full flex flex-row gap-8 justify-center items-center">
                        <button onClick={() => modifSection(1)} className="font-bold bg-gray-900 dark:bg-white text-white dark:text-black rounded-2xl p-2 transition-transform hover:scale-105">Languages</button>
                        <button onClick={() => modifSection(2)} className="font-bold bg-gray-900 dark:bg-white text-white dark:text-black rounded-2xl p-2 transition-transform hover:scale-105">Softwares</button>
                ...
                <div className="w-full dark:bg-gray-900 rounded-xl flex flex-col gap-8 p-8">
                    <h2 className="font-bold text-center w-full text-3xl">My bests projects</h2>
