        ...
        <>
            ...
            <div className="w-full flex flex-col items-center bg-white dark:bg-black text-black dark:text-white font-Fredoka bg-fixed gap-24">
                ...
                <div className="w-11/12  flex flex-col gap-20 mt-44">
                    <div className="w-full lg:h-[600px] dark:bg-gray-900 rounded-xl flex flex-col lg:flex-row items-center gap-8 p-8">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-normal gap-8 lg:pl-8">
                            ...
                            <p className="text-lg text-center lg:text-left w-full lg:w-3/4">My name is Mathéo, I'm 18 years old and I'm passionate about the IT and web developpement since 3 years. Actually, I'am searching an alternance in web developpement will start in february 2025 and finish in july 2026.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-11/12 lg:h-[650px] bg-gray-900 rounded-3xl flex flex-col gap-20 p-8 mt-24 text-white">
                    <h2 className="w-full text-center font-bold text-4xl">Qualities</h2>
                ...
                <div className="w-11/12 lg:h-[600px] bg-gray-900 rounded-3xl flex flex-col justify-center gap-12 p-12 text-white">
                    <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-8">
                        <div className="w-full lg:w-2/6 flex flex-col gap-8">
                            ...
                            <p className="text-sm">After a classic school parcour, I choose to go to an IT Bachelor (BUT) to learn to pratice programmation, but my goal is the same : become a software ingeneer</p>
                        </div>
                ...
                <div className="w-11/12 bg-gray-900 rounded-3xl flex flex-col items-center gap-8 p-8 lg:p-20 text-white">
                    <h2 className="w-full lg:w-2/6 font-bold text-4xl text-center">Professional experiences</h2>
                ...
                <div className="w-11/12 bg-gray-900 rounded-3xl flex flex-col items-center gap-12 p-8 text-white">
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-12 justify-center items-center">
                        <button onClick={() => modifSection(1)} className="font-bold bg-white text-black rounded-xl p-2 transition-transform hover:scale-105">Languages</button>
                        <button onClick={() => modifSection(2)} className="font-bold bg-white text-black rounded-xl p-2 transition-transform hover:scale-105">Softwares</button>
